  ...
  return (
    <div className="shared-users-container">
      ...
      <div className="shared-list">
        ...
        {/* <UserImage
          className="user-image-item"
          imgUrl="https://cdn.psychologytoday.com/sites/default/files/styles/image-article_inline_full/public/field_blog_entry_images/2018-09/shutterstock_648907024.jpg?itok=ji6Xj8tv"
        />
        <UserImage
          className="user-image-item"
